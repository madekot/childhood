...
<html lang="ru">
	<head>
        ...
        <link rel="shortcut icon" href="<?php echo get_template_directory_uri();?>/assets/img/favicons/favicon.ico" type="image/x-icon">
        <link rel="apple-touch-icon" href="<?php echo get_template_directory_uri();?>/assets/img/favicons/apple-touch-icon.png">
                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/svg/email.svg" alt="почта" class="header__contacts-logo">
                                <a href="mailto:<?php the_field('site_information__mail', 2)?>" class="header__contacts-mail"><?php the_field('site_information__mail', 2)?></a>
                            </div>
                            <div class="header__contacts-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/svg/phone.svg" alt="телефон" class="header__contacts-logo">
                                <div class="header__contacts-tel">
                                    <a href="tel:<?php the_field('site_information__phone', 2)?>"><?php the_field('site_information__phone', 2)?></a>
                                    <a href="tel:<?php the_field('site_information__phone--second', 2)?>"><?php the_field('site_information__phone--second', 2)?></a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="header__contacts-logo">
                                <address><?php the_field('site_information__adress', 2)?></address>
                            </div>
                        </div>
                    </div>
                </div>
