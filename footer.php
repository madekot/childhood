                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('site_information__instagram', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('site_information__facebook', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('site_information__youtube', 2)?>" class="footer__social-item">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/svg/phone.svg" alt="телефон" class="footer__contacts-logo">
                            ...
                            <div class="footer__contacts-item">
                                <img src="<?php echo get_template_directory_uri();?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
